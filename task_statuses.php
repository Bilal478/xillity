...
if (isset($_POST['create_package'])) {
    ...
    if ($actionId) {
        $query = "UPDATE jeoxillitycrm_task_statuses 
          SET name = '$name' 
          WHERE id = '$actionId'";
    } else {
        $query = "INSERT INTO jeoxillitycrm_task_statuses (name) 
              VALUES ('$name')";
    }
    runQuery($query);
...
if (isset($_GET['delete-record'])) {
    ...
    $query = "delete from jeoxillitycrm_task_statuses where id='$id'";
    runQuery($query);
}
?>
...
<body class="body-padding body-p-top">
                ...
                <div class="panel">
                    <div class="panel-header">
                        ...
                        <div class="btn-box d-flex flex-wrap gap-2">
                            ...
                            <button class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#addStatusModalLabel"><i class="fa-light fa-plus"></i> Add New
                            </button>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="btn-box">
                                                ...
                                                <button data-mydata='<? echo (json_encode($department, true)); ?>' class="btn btn-sm btn-icon btn-primary" data-bs-toggle="modal" data-bs-target="#addStatusModalLabel">
    ...
    <div class="modal fade" id="addStatusModalLabel" tabindex="-1" aria-labelledby="addStatusModalLabelLabel" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h2 class="modal-title" id="addStatusModalLabelLabel">Add Status</h2>
                    ...
                    <form method="post">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <input name="name" type="text" id="name" class="form-control form-control-sm" placeholder="Status Name">
                        ...
                        <div class="modal-footer">
                            ...
                            <input type="submit" class="btn btn-sm btn-primary" name="create_package" value="Save Status">
    ...
    <script>
        $(document).ready(function() {
            $('#addStatusModalLabel').on('show.bs.modal', function(e) {
                var modal = $(this);
                ...
                if (mydata !== null && mydata !== undefined) {
                    ...
                    $('#addStatusModalLabel').modal().show();
