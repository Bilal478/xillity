...
<head>
    ...
    <title>Error 408 | Digiboard</title>
        ...
        <div class="panel error-panel">
            ...
            <div class="panel-body h-100 d-flex flex-column align-items-center justify-content-center">
                ...
                <div class="part-img">
                    ...
                    <img src="assets/images/error-408.png" alt="408">

                </div>

                <div class="part-txt text-center">

                    <h2 class="error-subtitle">Rquest Time-Out</h2>

                    <a href="index.php" class="btn btn-primary py-2 px-5 rounded-pill">Go to Home Page</a>
