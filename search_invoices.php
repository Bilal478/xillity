...
// Modify SQL query to search by invoice title
$query = "SELECT * FROM " . $g_projectSlug . "_invoices WHERE title LIKE '%$search_query%' ORDER BY timeAdded DESC";
...
?>
    <tr>
        ...
        <td><?php echo $g_allUsersInfo[$row['client_id']]['name']; ?><br><small><?php echo $g_allUsersInfo[$row['client_id']]['email']; ?></small></td>
