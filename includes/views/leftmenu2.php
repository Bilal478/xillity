	...
	<div class="main-menu">
		...
		<ul class="sidebar-menu scrollable">
			...
			<li class="sidebar-item">
				...
				<ul class="sidebar-link-group">
					...
					<li class="sidebar-dropdown-item">
						...
						<a href="crm-dashboard.php" class="sidebar-link"><span class="nav-icon"><i class="fa-light fa-user-headset"></i></span> <span class="sidebar-txt">CRM Dashboard</span></a>
			...
			<li class="sidebar-item">
				...
				<a role="button" class="sidebar-link-group-title has-sub">Confiurations</a>
				...
				<ul class="sidebar-link-group">
					...
					<li class="sidebar-dropdown-item">
						...
						<ul class="sidebar-dropdown-menu" id="userDropdown">
							...
							<li class="sidebar-dropdown-item"><a href="all-employee.php" class="sidebar-link">All User</a></li>
