                ...
                <div class="main-logo d-lg-block d-none">
                    ...
                    <div class="logo-big">
                        ...
                        <a href="home.php">
                            ...
                            <img src="<? echo $g_modules_global['logo'] ?>" alt="Logo">
                            <!--<h2 class="text-white">Xillity</h2>-->
                        </a>
                    ...
                    <div class="logo-small">
                        ...
                        <a href="home.php">
                            ...
                            <img src="<? echo $g_modules_global['logo'] ?>" alt="Logo">
                            <!--<h4 class="text-white">Xillity</h4>-->
                        </a>
            ...
            <div class="col-xxl-6 col-xl-7 col-lg-8 col-4">
                ...
                <div class="header-right-btns d-flex justify-content-end align-items-center">
                    ...
                    <button class="header-btn theme-
                            ...
                            -btn d-lg-none"><i class="fa-light fa-gear"></i></button>
                    ...
                    <div class="header-btn-box profile-btn-box">
                        ...
                        <button class="profile-btn" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            if ($session_profile_pic != "") { ?>
                                <img src="./uploads/<?php echo $session_profile_pic; ?>" alt="image">
                            <?php } else { ?>
                        ...
                        <ul class="dropdown-menu profile-dropdown-menu">
                            ...
                            <li>
                                ...
                                <div class="dropdown-txt text-center">
                                    ...
                                    <p class="mb-0"><? echo $session_name ?></p>

                                    <span class="d-block"><? if ($session_role != '' && $session_role != '0') {
                                                                echo $session_role;
                                                            }
                                                            ?></span>
                            ...
                            <li><a class="dropdown-item" href="view-profile.php"><span class="dropdown-icon"><i class="fa-regular fa-circle-user"></i></span> Profile</a></li>

                            <li><a class="dropdown-item" href="chat.php"><span class="dropdown-icon"><i class="fa-regular fa-message-lines"></i></span> Message</a></li>
                            ...
                            <li><a class="dropdown-item" href="edit-profile.php"><span class="dropdown-icon"><i class="fa-regular fa-gear"></i></span> Settings</a></li>

                            <li><a class="dropdown-item" href="./?logout=1"><span class="dropdown-icon"><i class="fa-regular fa-arrow-right-from-bracket"></i></span> Logout</a></li>
