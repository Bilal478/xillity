...
if (isset($_POST['create_package'])) {
    ...
    if ($actionId) {
        $query = "UPDATE jeoxillitycrm_task_priorities 
          SET name = '$name' 
          WHERE id = '$actionId'";
    } else {
        $query = "INSERT INTO jeoxillitycrm_task_priorities (name) 
              VALUES ('$name')";
    }
    runQuery($query);
...
if (isset($_GET['delete-record'])) {
    ...
    $query = "delete from jeoxillitycrm_task_priorities where id='$id'";
    runQuery($query);
}
?>
...
<body class="body-padding body-p-top">
                ...
                <div class="panel">
                    <div class="panel-header">
                        ...
                        <div class="btn-box d-flex flex-wrap gap-2">
                            ...
                            <button class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#addPriorityModal"><i class="fa-light fa-plus"></i> Add New
                            </button>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="btn-box">
                                                ...
                                                <button data-mydata='<? echo (json_encode($department, true)); ?>' class="btn btn-sm btn-icon btn-primary" data-bs-toggle="modal" data-bs-target="#addPriorityModal">
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h2 class="modal-title" id="addPriorityModalLabel">Add Priority</h2>
                ...
                <div class="modal-body">
                    ...
                    <form method="post">
                        ...
                        <div class="modal-footer">
                            ...
                            <input type="submit" class="btn btn-sm btn-primary" name="create_package" value="Save Priority">
    ...
    <script>
        $(document).ready(function() {
            $('#addPriorityModal').on('show.bs.modal', function(e) {
                var modal = $(this);
                ...
                if (mydata !== null && mydata !== undefined) {
                    modal.find('.modal-title').text('Update Priority');
