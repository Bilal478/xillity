...
<head>
    ...
    <title>Coming Soon | Digiboard</title>
...
<body>
        ...
        <div class="panel coming-soon-panel coming-soon-panel-2">
            ...
            <div class="panel-body h-100 d-flex flex-column align-items-center justify-content-center">
                ...
                <div class="part-txt">
                    ...
                    <a href="index.php" class="btn btn-primary py-2 px-5 rounded-pill">Go To Home</a>
    ...
    <script src="assets/vendor/js/jquery.countdown.min.js"></script>
